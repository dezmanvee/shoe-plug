  ...
  return (
    <div className="flex-1 flex flex-col w-full max-sm:w-full">
        ...
        <div className="mt-4 flex justify-start gap-2.5">
            ...
            <p className="text-lg font-montserrat leading-normal text-slate-gray">{rating}</p>
        </div>
        <h3 className="mt-2 text-2xl font-semibold font-palanquin leading-normal">{name}</h3>
        <p className="mt-2 text-2xl font-semibold font-montserrat leading-normal text-coral-red">{price}</p>
    </div>
  )
}
